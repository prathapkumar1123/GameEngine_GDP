...
void BasicTextureManager::SetBasePath(std::string basepath)
{
...
bool BasicTextureManager::Create2DTextureFromBMPFile( std::string textureFileName, bool bGenerateMIPMap )
{
...
void BasicTextureManager::m_appendErrorString( std::string nextErrorText )
{
	std::stringstream ss;
...
GLuint BasicTextureManager::getTextureIDFromName( std::string textureFileName )
{
...
void BasicTextureManager::m_appendErrorStringLine( std::string nextErrorTextLine )
{
	std::stringstream ss;
...
std::string BasicTextureManager::PickRandomTexture(void)
{
...
bool BasicTextureManager::CreateCubeTextureFromBMPFiles( 
